...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="wrapper-text about-us">
            <h4 class="text-uppercase title mo-640">Về Chúng tôi</h4>
            <div class="about-img"><img class="img-responsive" src="assets/images/about-img.jpg" alt=""/></div>
            <h4 class="text-uppercase title tit-640">Về Chúng tôi</h4>
