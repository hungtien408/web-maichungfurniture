...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Banner Ghế Văn Phòng</h3>
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1170px x 270px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" 
        SelectMethod="ProductCategorySelectAll" TypeName="TLLib.ProductCategory"></asp:ObjectDataSource>
