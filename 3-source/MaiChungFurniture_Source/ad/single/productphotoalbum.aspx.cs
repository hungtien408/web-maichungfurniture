        ...
        try
        {
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(strImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 850, 850);
                    ResizeCropImage.CreateThumbNailByCondition("~/res/product/album/", "~/res/product/album/thumbs/", strImageName, 85, 85);
                }
